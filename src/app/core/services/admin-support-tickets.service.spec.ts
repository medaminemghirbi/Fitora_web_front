...
describe("AdminSupportTicketsService", () => {
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(AdminSupportTicketsService);
  ...
  it("list GETs without a status param by default", () => {
    ...
    const req = httpMock.expectOne((r) => r.url === `${API_BASE_URL}/admin/support_tickets`);
  ...
  it("resolve PATCHes with no body", () => {
    ...
    const req = httpMock.expectOne(`${API_BASE_URL}/admin/support_tickets/t1/resolve`);
