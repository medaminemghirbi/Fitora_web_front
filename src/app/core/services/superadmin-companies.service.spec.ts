...
describe("SuperadminCompaniesService", () => {
  let service: SuperadminCompaniesService;
  let httpMock: HttpTestingController;

  beforeEach(() => {
    TestBed.configureTestingModule({ providers: [provideHttpClient(), provideHttpClientTesting()] });
    service = TestBed.inject(SuperadminCompaniesService);
  ...
  it("list GETs with page param", () => {
    ...
    const req = httpMock.expectOne((r) => r.url === `${API_BASE_URL}/superadmin/companies`);
  ...
  it("get GETs a single company", () => {
    ...
    const req = httpMock.expectOne(`${API_BASE_URL}/superadmin/companies/co1`);
    expect(req.request.method).toBe("GET");
  ...
  it("updateSubscription PATCHes the subscription payload", () => {
    ...
    const req = httpMock.expectOne(`${API_BASE_URL}/superadmin/companies/co1/subscription`);
  ...
  it("updateSettings PATCHes a wrapped payload", () => {
    ...
    const req = httpMock.expectOne(`${API_BASE_URL}/superadmin/companies/co1/settings`);
    expect(req.request.method).toBe("PATCH");
  ...
  it("issues an invoice when the money arrives", () => {
    ...
    const req = httpMock.expectOne(`${API_BASE_URL}/superadmin/companies/co1/invoices`);
  ...
  it("voids one issued in error", () => {
    ...
    const req = httpMock.expectOne(`${API_BASE_URL}/superadmin/companies/co1/invoices/inv1`);
  ...
  it("impersonate POSTs with no body", () => {
    ...
    const req = httpMock.expectOne(`${API_BASE_URL}/superadmin/companies/co1/impersonate`);
    expect(req.request.method).toBe("POST");
