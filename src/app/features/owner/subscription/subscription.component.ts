...
export class SubscriptionComponent {
  ...
  // transaction. The request rides on the support ticket the owner can
  // already send and read back on /owner/support, rather than a second inbox
  ...
  openRequest(tier: TierCard): void {
    ...
    // Most owners already gave a number somewhere: theirs first, then the
