...
import { OwnerSupportComponent } from "./support.component";

describe("OwnerSupportComponent", () => {
  let fixture: ComponentFixture<OwnerSupportComponent>;
  let component: OwnerSupportComponent;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [OwnerSupportComponent, TranslateModule.forRoot()],
      providers: [{ provide: SupportTicketsService, useValue: service }],
    }).compileComponents();

    fixture = TestBed.createComponent(OwnerSupportComponent);
