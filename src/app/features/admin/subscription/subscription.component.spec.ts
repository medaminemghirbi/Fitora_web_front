...
describe("SubscriptionComponent", () => {
  ...
  describe("the tiers", () => {
    ...
    it("marks exactly the tier the admin is on", () => {
      withTiers(3);
    ...
    it("matches the unlimited tier for an admin with no limit", () => {
      withTiers(null);
    ...
    // Every tier carries the whole of Gymly, so the modules are ticked
